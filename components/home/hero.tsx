...
const Hero = () => {
  return (
    <div className="flex lg:flex-row flex-col gap-y-10 items-center px-5 lg:px-8 gap-x-12 pt-24 lg:pt-32 pb-16 lg:pb-24 bg-[#FAF9F6CC]">
      <div className="basis-[50%] flex flex-col gap-y-6">
        ...
        <div className="xl:mt-4 flex md:flex-row flex-col justify-center lg:justify-start gap-4">
